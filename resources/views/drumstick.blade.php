@extends('layout')
@section('title', 'TalipaFast - Fresh Goodies - Chicken Drumstick')
@section('content')
    <head>
    <style> 
    ...
    <body style="background-color: #FAF9F6;">
        <div class="cover">
            ...
            <a class="image">
                <img src="images/drumstick.png" alt="drumstick" class="imgs">
            </a>
            <div class="text">
                <div>
                    <b><h3 style="color: black;">Chicken Drumstick</h3></b>
                    <br>
