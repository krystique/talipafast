@extends('layout')
@section('title', 'TalipaFast - Fresh Goodies - Beef Bone Marrow')
@section('content')
    <head>
    <style> 
    ...
    <body style="background-color: #FAF9F6;">
        <div class="cover">
            ...
            <a class="image">
                <img src="images/beefbonemarrow.png" alt="beefbonemarrow" class="imgs">
            </a>
            <div class="text">
                <div>
                    <b><h3 style="color: black;">Beef Bone Marrow</h3></b>
                    <br>
